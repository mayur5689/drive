...
export default function CreateTaskModal({ isOpen, onClose, onSuccess, profiles, teamMembers }: CreateTaskModalProps) {
    const { user } = useAuth();
    ...
    const handleCreate = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Find either the team member or profile to get display info for UI update
    ...
    // Only show official team members
